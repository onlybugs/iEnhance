...
class Config():
    ...
    trainfp = "gm64_no_scn_train.npz"
    testfp = "gm64_no_scn_test.npz"
    logn = 'log-norm-node4g-ga13.txt'
    node = 'node4'
...
if(cTrain == "0"):
    ...
    mdl = t.load("msave/Norm-module-ga6-20.pt")
...
for e in range(cfg.epoc_num):
    ...
    t.save(mdl,"msave/Norm-module-ga13"+ "-" + str(e)+".pt")
    ...
    if now_ssim > best_ssim:
        ...
        t.save(mdl,"predictm/Norm-module-ga13best"+ "-" + str(e)+".pt")
